...
The following list includes only the interface request parameters and some common parameters. For a complete list of common parameters, please see [Accessing Server APIs](../accessing-server-apis.mdx).
...
<td>Number</td>
<td>Yes</td>
<td>Message type, please refer to [MessageBody Introduction](./messagebody-introduction.mdx) for the applicable types of all user pushes. </td>
</tr>
<tr>
<td>MessageBody</td>
<td>Object</td>
<td>Yes</td>
<td>Message content, please refer to [MessageBody Introduction](./messagebody-introduction.mdx) for specific parameter format.<Warning title="Warning"><p>Setting is not supported at this time.</p></Warning></td>
</tr>
<tr>
<td>SubMsgType</td>
<td>Number</td>
...
The following only lists the return codes related to the interface business logic. For the complete list of return codes, please refer to [Return Codes](../return-codes.mdx).
