...
<td>Number</td>
<td>Yes</td>
<td>Message type. For more information about message types applicable to a group chat, see [MessageBody Introduction](./messagebody-introduction.mdx). Signaling messages are not supported. </td>
</tr>
<tr>
<td>Priority</td>
<td>Number</td>
...
<td>Object</td>
<td>Yes</td>
<td>Message content. For more information about the format, see [MessageBody Introduction](./messagebody-introduction.mdx). Offline push is not supported. <Warning title="Warning">`OfflinePush` and `HasReceipt` are not supported.</Warning></td>
</tr>
<tr>
<td>SubMsgType</td>
<td>Number</td>
...
After messages are imported successfully, call the ZIM server API [`Query the message list of group chats`](../conversation/query-the-message-list-of-group-chats.mdx) to check whether all group messages are imported.
