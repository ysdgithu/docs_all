...
<li>If all operations for the conversations fail, Code will return the corresponding return code. Please refer to the [Return codes](./../return-codes.mdx) for details.</li>
</ul>
</Note>
</td>
</tr>
