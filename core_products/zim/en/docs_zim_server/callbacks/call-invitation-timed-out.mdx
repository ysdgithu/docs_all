...
If none of the callees respond within the specified time and the caller is online, a [callback on call invitation canceled](./call-invitation-canceled.mdx) will be triggered.
</Note>
