...
<td>Object</td>
<td>Yes</td>
<td>Offline push configuration, please refer to [MessageBody Introduction](../messaging/messagebody-introduction.mdx) for the details of offline push parameter.</td>
</tr>
</tbody></table>
